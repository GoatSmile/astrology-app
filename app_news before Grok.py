...
with st.form("astro_form"):
    ...
    <div class='result-card'>
        <h3>📰 Recent Headlines about {love_choice}</h3>
        <p>H</p>
        <p>
    ...
    if news_items:
        ...
        st.markdown("<p>No recent news found for this topic</p>", unsafe_allow_html=True)

    st.markdown("<p>H2</p></ul></div></p>", unsafe_allow_html=True)
