...
load_dotenv()  # 👈 Must have this line!
...
# print("ENV VARIABLES:", os.environ.get("OPENAI_API_KEY"))  # Debug line
...
if submitted:
    ...
    with col1:
        st.image(image_url, use_container_width=True)  # Updated parameter name
